import { Building2Icon, CalendarIcon, FileTextIcon, User, UserIcon } from 'lucide-react'
    ...
    const stats = [
        {
...

         {
            ...
            label:"Todat's Attendance",
            description:"Chedked in today"
        },
          ...
          return (
            ...
            >
              <div className="">
                ...
                <p className="text-sm text-slate-400">{s.subtitles}</p>
              </div>
