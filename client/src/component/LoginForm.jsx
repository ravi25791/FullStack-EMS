...
import { ArrowLeftIcon, EyeClosed, EyeIcon, EyeOffIcon, Loader2Icon } from "lucide-react";
        ...
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
                <div className="w-full max-w-md animate-fade-in">
                    <Link
                        to="/login"
                        className="inline-flex items-center gap-2 text-sm text-slate-500 mb-10 transition-colors"
                    >
